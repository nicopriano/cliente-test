...
/*!**********************************!*\
  !*** ./server/contextManager.js ***!
  \**********************************/
/*! exports provided: getDataForContext */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getDataForContext\", function() { return getDataForContext; });\n/* harmony import */ var _itemsManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./itemsManager */ \"./server/itemsManager.js\");\n\nconst getDataForContext = (url, query) => {\n  if (url.includes('/items/')) {\n    return Object(_itemsManager__WEBPACK_IMPORTED_MODULE_0__[\"getItemDetail\"])(url.replace('/items/', ''));\n  } else if (url.includes('/items?')) {\n    return Object(_itemsManager__WEBPACK_IMPORTED_MODULE_0__[\"getItems\"])(query.search);\n  } else {\n    return Promise.resolve();\n  }\n};\n\n//# sourceURL=webpack:///./server/contextManager.js?");
